...
// =========================================================
// Alerts & Logs page data
// =========================================================

export const alertsLogsData = [
  { id: "LOG-092", type: "critical", title: "Methane Threshold Exceeded", desc: "CH4 levels reached 5.2% LEL in Zone B3. Automatic shutdown protocol initiated for nearby equipment.", zone: "Zone B3", time: "14:21:05", date: "Today" },
  { id: "LOG-091", type: "warning", title: "Unusual Geophone Vibration", desc: "Spike of 1.8g detected. Possible minor rockfall or heavy machinery movement nearby.", zone: "Zone A2", time: "14:18:22", date: "Today" },
  { id: "LOG-090", type: "info", title: "LoRa Relay Node Deployed", desc: "Rover successfully dropped Relay Node #3 to extend mesh network coverage.", zone: "Node #3", time: "14:14:10", date: "Today" },
  { id: "LOG-089", type: "critical", title: "Victim Signature Detected", desc: "Thermal camera identified heat signature matching human profile. Confidence: 87%.", zone: "Zone C1", time: "14:12:00", date: "Today" },
  { id: "LOG-088", type: "warning", title: "Rover Motor Temp High", desc: "Drive motor temperature reached 85°C. Reducing speed by 20% to compensate.", zone: "Rover Chassis", time: "13:55:41", date: "Today" },
  { id: "LOG-087", type: "info", title: "Rover Docked", desc: "Rover successfully connected to docking station for recharge.", zone: "Base Station", time: "13:45:00", date: "Today" },
  { id: "LOG-086", type: "warning", title: "Telemetry Delay", desc: "Packet loss of 12% detected on main control frequency. Switched to backup channel.", zone: "Comms Array", time: "12:10:15", date: "Today" },
];
