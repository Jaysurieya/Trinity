...
import { Settings,Flame,Cloud,Skull,Droplets,Car,ArrowLeft,ArrowRight} from 'lucide-react';
...
export const ArrowLeftIcon = ({ size = 20, color = '#ffffff', ...props }) => (
  <ArrowLeft size={size} color={color} {...props} />
);
...
export const ArrowRightIcon = ({ size = 20, color = '#ffffff', ...props }) => (
